...
public class IntegerAABB {
    ...
    public static class Builder {
        ...
        public IntegerAABB build() {
            return this.seenFirst ? new IntegerAABB(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ)
                    : null;
        }
    ...
    /**
     * Creates a new {@link IntegerAABB} that has been contracted by the given
    ...
    /**
     * Creates a new {@link IntegerAABB} that has been expanded by the given amount,
    ...
    /**
     * Creates a new {@link IntegerAABB} that is expanded by the given value in all
    ...
    public IntegerAABB offset(int x, int y, int z) {
        return new IntegerAABB(this.minX + x, this.minY + y, this.minZ + z, this.maxX + x, this.maxY + y,
                this.maxZ + z);
    }

    public IntegerAABB offset(BlockPos pos) {
        return new IntegerAABB(this.minX + (int) pos.getX(), this.minY + (int) pos.getY(), this.minZ + (int) pos.getZ(),
                this.maxX + (int) pos.getX(), this.maxY + (int) pos.getY(), this.maxZ + (int) pos.getZ());
    }
    ...
    public BlockPos getCenter() {
        return new BlockPos(this.minX + (this.maxX - this.minX) * 0.5D, this.minY + (this.maxY - this.minY) * 0.5D,
