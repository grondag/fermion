...
{
    //TODO: needs to be redone or scrapped due to 1.14 changes
...
//    
    ...
    public static void setTextureBlurMipmap(final boolean enableBlur, final boolean isMoreThanOnePixel)
    {
        if (enableBlur)
        {
            GlStateManager.texParameter(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, isMoreThanOnePixel ? GL11.GL_LINEAR_MIPMAP_LINEAR : GL11.GL_LINEAR);
            GlStateManager.texParameter(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_LINEAR);
        }
        else
        {
            GlStateManager.texParameter(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, isMoreThanOnePixel ? GL11.GL_NEAREST_MIPMAP_LINEAR : GL11.GL_NEAREST);
