...
import grondag.fermion.sc.concurrency.PrivilegedExecutor;
                ...
                public void run() {
                    ...
                    if (plain.isEmpty()) {
                        System.out.println(String.format(
                                "Plain tasks are done with %d in privileged set. (Should be zero)", privileged.size()));
            ...
            Runnable rSpecial = new Runnable() {
                ...
                public void run() {
                    ...
                    if (privileged.isEmpty()) {
                        System.out.println(String.format(
                                "Privileged tasks are done with %d in plain set. (Should be > 500)", plain.size()));
