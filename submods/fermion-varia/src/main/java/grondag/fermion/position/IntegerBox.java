...
public class IntegerBox {
    ...
    public static class Builder {
        ...
        public IntegerBox build() {
            return this.seenFirst ? new IntegerBox(this.minX, this.minY, this.minZ, this.maxX, this.maxY, this.maxZ)
                    : null;
        }
    ...
    public boolean equals(Object other) {
        if (other == null) {
            ...
            return true;
        } else if (!(other instanceof IntegerBox)) {
            return false;
        } else {
            IntegerBox otherBox = (IntegerBox) other;
    ...
    public IntegerBox offset(int x, int y, int z) {
        return new IntegerBox(this.minX + x, this.minY + y, this.minZ + z, this.maxX + x, this.maxY + y,
                this.maxZ + z);
    }

    public IntegerBox offset(BlockPos pos) {
        return new IntegerBox(this.minX + (int) pos.getX(), this.minY + (int) pos.getY(), this.minZ + (int) pos.getZ(),
