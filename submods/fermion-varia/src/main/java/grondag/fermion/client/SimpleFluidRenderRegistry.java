...
class SimpleFluidRenderRegistry implements SimpleSynchronousResourceReloadListener {
	...
	static void register(Fluid fluid, int color, String stillSprite, String flowingSprite) {
		SimpleFluidRenderHandler handler = new SimpleFluidRenderHandler(color, stillSprite, flowingSprite);
